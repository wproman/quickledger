            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-lg text-gray-700 italic mb-6">
                  ...
                  our entire accounting process. Theve been very patient in the
                  planning phase of our new ERP system entrusted Fourlane with
                  the future of our business and s been the best move wve made
                  to dat
                </p>
                <div className="flex items-center">
                  <div className="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center mr-4">
                    <span className="text-blue-800 font-bold">GG</span>
                  </div>
                  <div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <Quote className="w-8 h-8 text-blue-600 mb-4 rotate-180" />
                <p className="text-lg text-gray-700 italic mb-6">
                  have been working with Fourlane for over three years now. They
                  are wonderful and a pleasure to work with. They have improved
                  our inventory management and month-end process tremendous
                </p>
                <div className="flex items-center">
                  <div className="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center mr-4">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-lg text-gray-700 italic mb-6">
                  ...
                  with a new file, keeping important data, and purging the old
                  data, all with minimal downti
                </p>
                <div className="flex items-center">
                  <div className="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center mr-4">
                    <span className="text-blue-800 font-bold">JC</span>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900">
                      John Costelli
              ...
              <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <Quote className="w-8 h-8 text-blue-600 mb-4 rotate-180" />
                <p className="text-lg text-gray-700 italic mb-6">
                  urlane helped us convert from NetSuite to Quickbooks very
                  impressed with the professionalism and competency of everyone
                  at Fourlane, without exception. We had a short deadline and
                  Fourlane helped us meet it while patiently explaining the proc
                </p>
                <div className="flex items-center">
                  <div className="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center mr-4">
                    <span className="text-blue-800 font-bold">JR</span>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900">
                      Jim Roundtree
